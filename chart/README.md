...
| instance_id | string | `"artifactdb"` | Instance ID, lowercase, no space, 16 chars max. |
| instance_version | string | `"v1"` | Instance version, used as a path prefix in the URL. |
...
| resources | object | `{"limits":{"cpu":null,"memory":null},"requests":{"cpu":null,"memory":null}}` | Specifies pod resources. |
